...
module.exports = grammar({
  ...
  rules: {
    ...
    // Main Grammar
    // bisearch
    binary_search_sub_expression : $ => seq(
      '[',
      repeat($._top_level_item),
      ']'
    ), 
    bsearch_optional_expression : $ => seq(
      ',',
      $._expression
    ),
    binary_search_stem_expression : $ => seq(
      '[',
      $.primitive_type,
      ',',
      $.identifier,
      ...
      ',',
      $._expression,
      optional($.bsearch_optional_expression),
      ']'
    ),
    binary_search_expression: $ => seq(
      choice(
        'bsearch_min',
        'bsearch_max',
        'tsearch_min',
      ...
      $.binary_search_stem_expression,
      optional($.binary_search_sub_expression),
       '(',
       $._expression,
       ')'
      // minimval
    ...
    seq(
      'rep',
      optional(seq('[', field('array_name', $._expression) , ']')),
      '(',
      choice(
        seq(field('condition',$._expression)),
        seq(
          seq(field('initializer',$.identifier)),
          ',',
          seq(field('condition',$._expression))
        ),
        seq(
          seq(field('initializer',$.identifier)),
          ',',
          seq(field('initial_condition',$._expression)),
          ',',
          seq(field('terminal_condition',$._expression))
        ),
        seq(
          seq(field('initializer',$.identifier)),
          ',',
          ...
          seq(field('terminal_condition',$._expression)),
          ',',
          seq(field('increment_condition',$._expression))
        )
      ),
      ')',
      $._statement
    ...
    break_break_statement: $ => seq(
      /(break)(_break|_continue)+/ , ';'
    ),
      ...
      return token(seq(
        ...
        choice(
          seq(
            choice(
              decimalDigits,
              seq(decimalDigits, 'd', decimalDigits),
